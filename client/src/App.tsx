...
const challengeCards: Array<{
  ...
  { key: "quiz", title: "Quiz de Segurança", eyebrow: "Conhecimento rápido", description: "Aprenda a reconhecer riscos, cuidar de si e proteger quem trabalha com você.", icon: ShieldCheck, tone: "cyan", stat: "16 perguntas" },
